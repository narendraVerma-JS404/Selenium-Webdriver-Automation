...
public class ReteriveCon {
	...
	Thread.sleep(3000);
	  ...
	  //INTER INTO FRAME
	    ...
	    String str = driver.findElement(By.xpath("//select[@id='cmbCountry']")).getText();
	    System.out.println(str);
	    driver.findElement(By.name("txtState")).sendKeys("Kal");
	    driver.findElement(By.name("txtAddress")).sendKeys("kolkata hawada");
	    driver.findElement(By.name("txtZIP")).sendKeys("256456");
